...
Write-Host "Portainer installé avec succes !"
Write-Host "Acces NodePort : http://${nodeIP}:${nodePort}"
Write-Host "Ou acces local : kubectl port-forward -n portainer svc/portainer 9000:9000"
